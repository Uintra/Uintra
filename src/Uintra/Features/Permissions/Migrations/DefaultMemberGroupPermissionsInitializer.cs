...
using static Uintra.Infrastructure.Constants.UsersInstallationConstants;
using Resource = Uintra.Features.Permissions.PermissionResourceTypeEnum;

namespace Uintra.Features.Permissions.Migrations
{
