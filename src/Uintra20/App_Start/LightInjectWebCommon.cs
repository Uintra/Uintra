...
using Uintra20.Features.Localization;
...
using Uintra20.Features.User.Entities;
using Uintra20.Features.User.RelatedUser;
...
using Configuration = Uintra20.Persistence.Sql.Migrations.Configuration;
...
namespace Uintra20
{
    public static class LightInjectWebCommon
    {
        ...
        public static void Start(Composition composition)
        {
            ...
            Database.SetInitializer(new MigrateDatabaseToLatestVersion<DbObjectContext, Configuration>());
