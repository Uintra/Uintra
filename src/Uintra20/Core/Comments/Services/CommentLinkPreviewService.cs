...
namespace Uintra20.Core.Comments
{
    public class CommentLinkPreviewService : ICommentLinkPreviewService
    {
        ...
        #region async
        public async Task<LinkPreview.LinkPreview> GetCommentsLinkPreviewAsync(Guid commentId)
        {
        ...
        public LinkPreview.LinkPreview GetCommentsLinkPreview(Guid commentId)
        {
