...
namespace Compent.uIntra.Installer
{
    public class UmbracoContentMigration
    {
        ...
        private void CreateHomePage()
        {
            ...
            var content = _contentService.CreateContentWithIdentity("Home Page", -1, DocumentTypeAliasConstants.HomePage);
            content.SetValue(NavigationPropertiesConstants.NavigationNamePropName, "Home Page");
        ...
        private void CreateProfileEditPage()
        {
            ...
            var content = _contentService.CreateContent("Profile Edit Page", homePage.Id, DocumentTypeAliasConstants.ProfileEditPage);
        ...
        private void CreateSearchResultPage()
        {
            ...
            var content = _contentService.CreateContent("Search Page", homePage.Id, DocumentTypeAliasConstants.SearchResultPage);
            content.SetValue(NavigationPropertiesConstants.NavigationNamePropName, "Search Page");
            content.SetValue(NavigationPropertiesConstants.IsHideFromLeftNavigationPropName, true);
            content.SetValue(NavigationPropertiesConstants.IsHideFromSubNavigationPropName, true);
        ...
        private void CreateErrorPage()
        {
            ...
            var content = _contentService.CreateContent("Error Page", homePage.Id, DocumentTypeAliasConstants.ErrorPage);
            content.SetValue(NavigationPropertiesConstants.NavigationNamePropName, "Error Page");
            content.SetValue(NavigationPropertiesConstants.IsHideFromLeftNavigationPropName, true);
            content.SetValue(NavigationPropertiesConstants.IsHideFromSubNavigationPropName, true);
