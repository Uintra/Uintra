...
<p>FullName: ##FullName##</p>");
        ...
        {
            var gridContent = CoreInstallationStep.GetEmbeddedResourceValue($"{Assembly.GetExecutingAssembly().FullName}.Installer.ContentPageJsons.{gridEmbeddedResourceFileName}");
