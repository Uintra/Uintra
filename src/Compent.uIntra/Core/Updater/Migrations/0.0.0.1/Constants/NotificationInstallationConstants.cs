...
namespace Compent.Uintra.Core.Updater.Migrations._0._0._0._1.Constants
{
    public class NotificationInstallationConstants
    {
        ...
        {
            public const string ItemCountForPopup = "ItemCountForPopup";
        }
        public class DocumentTypeIcons
        {
            public const string NotificationPage = "icon-timer";
        }
        ...
        {
            public const string NotificationTypeEnum = "Notification Type Enum Dropdown";
        }
