...
namespace Compent.uIntra.Core.PagePromotion
{
    public class PagePromotionAutoMapperProfile : Profile
    {
        protected override void Configure()
        {
            ...
            //   .ForMember(dst => dst.IsShareEnabled, src => src.Ignore());

            //Mapper.CreateMap<Entities.PagePromotion, PagePromotionItemViewModel>()
            ...
            //    .ForMember(dst => dst.IsShareEnabled, src => src.MapFrom(el => el.IsShareEnabled));

            //Mapper.CreateMap<Entities.PagePromotion, IntranetActivityItemHeaderViewModel>()
